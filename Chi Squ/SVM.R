...
sapdata<-read.csv("F:/Thesis/DataMing+MachieLeaning/Diabetes/Chi Squ/Sap_SVM_Selected.csv")
...
write.csv(sapdata,"F:/Thesis/DataMing+MachieLeaning/Diabetes/Chi Squ/Sap_SVM_Selected.csv")
