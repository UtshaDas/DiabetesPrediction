...
sapdata<-read.csv("F:/Thesis/DataMing+MachieLeaning/Diabetes/Common/Sap_SVM_Selected.csv")
...
write.csv(sapdata,"F:/Thesis/DataMing+MachieLeaning/Diabetes/Common/Sap_SVM_Selected.csv")
