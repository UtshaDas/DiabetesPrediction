...
sapdata<-read.csv("F:/Thesis/DataMing+MachieLeaning/Diabetes/RFE-RF/Sap_DT_Selected.csv")
...
write.csv(sapdata,"F:/Thesis/DataMing+MachieLeaning/Diabetes/RFE-RF/Sap_DT_Selected.csv")
print(cp_op)
print(max_dep)
print(min_split)
print(accu)
