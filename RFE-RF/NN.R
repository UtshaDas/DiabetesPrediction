library(neuralnet)
library(pROC)
trainDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/Diabetes/RFE-RF/Normalized_Dataset_Train80p_top10.csv")
testDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/Diabetes/RFE-RF/Normalized_Dataset_Test20p_top10.csv")
